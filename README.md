...
```javascript
import dispatchBy from 'https://cdn.jsdelivr.net/gh/stdlib-js/strided-dispatch-by@v0.2.0-deno/mod.js';
```
...
[@stdlib/strided/dispatch]: https://github.com/stdlib-js/strided-dispatch/tree/deno
